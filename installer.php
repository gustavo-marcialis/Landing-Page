...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Digitalwave_4485398fe7edf55e8512_20230525173028_archive.daf';
        const ARCHIVE_SIZE       = '86013746';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '4485398-25173028';
        const SECONDARY_PACKAGE_HASH = 'd0c4489-25173028';
        const VERSION            = '1.5.4';
